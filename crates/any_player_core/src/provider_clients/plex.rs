...
impl PlexApiClient {
    ...
    pub async fn get_tracks_from_endpoint(
        &self,
        base_url: &str,
        token: &str,
        endpoint: &str,
        ...
        let response = self
            .client
            .get(Self::authed_url(base_url, token, &paginated_endpoint))
    ...
    pub async fn get_all_tracks_from_endpoint(
        &self,
        base_url: &str,
        token: &str,
        endpoint: &str,
